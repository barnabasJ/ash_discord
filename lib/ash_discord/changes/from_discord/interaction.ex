defmodule AshDiscord.Changes.FromDiscord.Interaction do
  ...
  defp transform_interaction(changeset, interaction_data) do
    ...
    |> maybe_set_attribute(:guild_discord_id, interaction_data.guild_id)
    |> maybe_set_attribute(:channel_discord_id, interaction_data.channel_id)
    |> maybe_set_attribute(:user_discord_id, user_discord_id)
