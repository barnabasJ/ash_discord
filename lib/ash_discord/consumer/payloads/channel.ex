defmodule AshDiscord.Consumer.Payloads.Channel do
  ...
  typed_struct do
    ...
    field :position, :integer, allow_nil?: true, description: "Sorting position of the channel"

    field :permission_overwrites, {:array, :map},
      allow_nil?: true,
      description: "Permission overwrites for members and roles"

    field :name, :string, allow_nil?: true, description: "The name of the channel"
    field :topic, :string, allow_nil?: true, description: "The channel topic"
    field :nsfw, :boolean, allow_nil?: true, description: "Whether the channel is NSFW"
    ...
    field :owner_id, :integer, allow_nil?: true, description: "Id of the DM creator"
