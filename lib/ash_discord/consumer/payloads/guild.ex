defmodule AshDiscord.Consumer.Payloads.Guild do
  ...
  typed_struct do
    ...
    field :icon, :string, allow_nil?: true, description: "The hash of the guild's icon"
    field :splash, :string, allow_nil?: true, description: "The hash of the guild's splash"
    ...
    field :unavailable, :boolean,
      allow_nil?: true,
      description: "Whether the guild is available"
    ...
    field :banner, :string, allow_nil?: true, description: "The hash of the guild's banner"
