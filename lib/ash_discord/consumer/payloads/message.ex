defmodule AshDiscord.Consumer.Payloads.Message do
  ...
  typed_struct do
    ...
    field :webhook_id, :integer,
      allow_nil?: true,
      description:
        "If the message is generated by a webhook, this is the webhook's id (nil otherwise)"
    ...
    field :application, :map,
      allow_nil?: true,
      description:
        "Sent with Rich Presence-related chat embeds (optional, partial application object)"
