defmodule AshDiscord.Changes.FromDiscord.UserTest do
  ...
  describe "struct-first pattern" do
    ...
    test "creates user from discord struct with all attributes" do
      ...
      created_user = TestApp.Discord.user_from_discord!(%{data: user_struct})
    ...
    test "handles bot users correctly" do
      ...
      created_user = TestApp.Discord.user_from_discord!(%{data: bot_struct})
  ...
  describe "API fallback pattern" do
    ...
    test "fetches user from API when data not provided" do
      ...
      created_user = TestApp.Discord.user_from_discord!(%{identity: discord_id})
  ...
  describe "upsert behavior" do
    ...
    test "updates existing user instead of creating duplicate" do
      ...
      original_user = TestApp.Discord.user_from_discord!(%{data: initial_struct})
      ...
      updated_user = TestApp.Discord.user_from_discord!(%{data: updated_struct})
    ...
    test "upsert works with API fallback" do
      ...
      updated_user = TestApp.Discord.user_from_discord!(%{identity: discord_id})
